...
var games = [730, 440, 570, 1671340];  // Enter here AppIDs of the needed games
...
var games2 = [730, 440, 570, 1763050];  // Enter here AppIDs of the needed games
...
var games3 = [730, 440, 570, 2120900];  // Enter here AppIDs of the needed games
...
user3.on('loggedOn', () => {
 	...
 	user3.setPersona(statu3);               
 	user3.gamesPlayed(games3);
 });


var username4 = process.env.username3;
var password4 = process.env.password3;
var shared_secret4 = process.env.shared3;

var games4 = [730, 440, 570, 2506160];  // Enter here AppIDs of the needed games
var status4 = 7;  // 1 - online, 7 - invisible
